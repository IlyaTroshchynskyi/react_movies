...
const Backdrop = (props) => {
  return (
      <div className="relative z-10" aria-labelledby="modal-title" role="dialog" aria-modal="true" onClick={props.onClose}>
          ...
          <div className="bg-white px-4 pb-4 pt-5 sm:p-6 sm:pb-4">
            <div className="sm:flex sm:items-start">
              ...
              <div className="mt-3 text-center sm:ml-4 sm:mt-0 sm:text-left">
                <h3 className="text-base font-semibold leading-6 text-gray-900" id="modal-title">Are you sure you want to delete record?</h3>
              </div>
            </div>
          </div>
  ...
  return (
    <Fragment>
      ...
      {ReactDOM.createPortal(
        <ModalOverlay onClose={props.onClose} setDeleting={props.setDeleting} onDelete={props.onDelete}>{props.children}
        </ModalOverlay>,
        portalElement
      )}
    </Fragment>
